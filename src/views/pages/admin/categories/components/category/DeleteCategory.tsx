...
import { deleteCategory } from 'src/service/category'
...
const DeleteCategory = ({ open, onClose, data, onDeleted }: DeleteUserProps) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      toast.success(t('Delete category successfully'))
      onClose()
