...
import { CreatePaymentMethod, DeletePaymentMethod, UpdatePaymentMethod } from './components'
      ...
      renderCell: params => (
        <Box sx={{ display: 'flex', gap: 4 }}>
          ...
          {params.row.deletedAt && (
            <Box sx={{ cursor: 'pointer', color: '#0d6efd' }} onClick={() => handleRestore(params.row.id)}>
